<template>
    <div class="flex justify-center">
        <form method="POST" class="p-12" @submit.prevent="add">
			...
			<div class="text-center mt-6">
                <button class="bg-blue-900 rounded-full hover:bg-blue-700 text-white text-center mx-auto active:bg-yellow-400 text-sm font-bold uppercase px-6 py-3 shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="submit" style="transition: all 0.15s ease 0s;">Add Post</button>
			</div>
        </form>
    </div>
</template>
